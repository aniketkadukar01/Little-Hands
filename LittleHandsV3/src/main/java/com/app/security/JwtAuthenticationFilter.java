...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
	...
	protected void doFilterInternal(HttpServletRequest request
		...
		if (authHeader != null && authHeader.startsWith("Bearer ")) {
			...
			/*
			 * save this Authentication object , containing - email , user id n granted
			 * authorities , under spring security context , so that subsequent filters will
			 * NOT retry the authentication again (isAuthenticated is already set to true)
			 */
